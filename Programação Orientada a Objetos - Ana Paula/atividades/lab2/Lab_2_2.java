...
public class Lab_2_2 {
    ...
    static class Produto {
        ...
        Produto(String nome, int quantidade, String tipo, double preco) {
            this();
            this.nome = nome;
            this.quantidade = quantidade;
            this.tipo = tipo;
    ...
    public static void main(String[] args) {
        ...
        Produto produto2 = new Produto( nome, quantidade, tipo, preco);
        ...
        Produto produto3 = new Produto(nome3, quantidade3, tipo3, preco3);
