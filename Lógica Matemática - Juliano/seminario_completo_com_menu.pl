...
menu :-
    repeat,
    nl, write('--- MENU ACADEMIA ---'), nl,
    write('1. Realizar Matrícula'), nl,
    write('2. Consultar Progresso'), nl,
    write('3. Sair'), nl,
    write('Escolha uma opção: '), read(Opcao),
    (
        Opcao = 1 -> matricula, !;
        Opcao = 2 -> 
            write('Digite o nome do cliente para consultar o progresso: '), read(Nome),
            progresso(Nome), !;
        Opcao = 3 -> write('Saindo do programa. Até mais!'), nl;
